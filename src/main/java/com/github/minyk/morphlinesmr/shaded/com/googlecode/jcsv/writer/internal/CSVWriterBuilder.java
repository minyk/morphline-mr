...
import com.github.minyk.morphlinesmr.shaded.com.googlecode.jcsv.util.Builder;
...
import com.github.minyk.morphlinesmr.shaded.com.googlecode.jcsv.writer.internal.*;
...
public class CSVWriterBuilder<E> implements Builder<CSVWriter<E>>{
	...
	public CSVWriter<E> build() {
		...
		return new com.github.minyk.morphlinesmr.shaded.com.googlecode.jcsv.writer.internal.CSVWriterImpl<E>(this);
	}
